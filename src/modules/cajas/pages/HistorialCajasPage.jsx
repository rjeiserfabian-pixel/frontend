        ...
        <TableContainer>
          <Table size="small" sx={{ minWidth: 800 }}>
            <TableHead sx={{ bgcolor: alpha(C.surfaceSoft, 0.92) }}>
              <TableRow>
                <TableCell sx={{ fontWeight: 800, py: 2, color: '#bae6fd' }}>Caja y Responsable</TableCell>
                <TableCell sx={{ fontWeight: 800, py: 2, color: '#bae6fd' }}>Apertura</TableCell>
                <TableCell sx={{ fontWeight: 800, py: 2, color: '#bae6fd' }}>Cierre</TableCell>
