...
export default function CategoriasPage() {
  ...
  const puedeCrear = tienePermiso('INVENTARIO.CATEGORIAS.CREAR');
  const puedeEditar = tienePermiso('INVENTARIO.CATEGORIAS.EDITAR');
  const puedeEliminar = tienePermiso('INVENTARIO.CATEGORIAS.ELIMINAR');
